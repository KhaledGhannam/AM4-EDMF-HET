...
precipconv_land = zpblRi; precipconv_land(xx<0.4)=NaN;
precipconv_ncep_land = zpblRi_ncep; precipconv_ncep_land(xx<0.4)=NaN;
precipconv_am4_land = zpblRi_am4; precipconv_am4_land(xx<0.4)=NaN;


% --- western US ----
id1 = find(lon>=244 & lon<=250);
id2 = find(lat>25 & lat<35);
...
% --- central US ----
id1 = find(lon>=260 & lon<=266);
id2 = find(lat>36 & lat<42);
...
% --- Eastern US ----
id1 = find(lon>=279 & lon<=286);
id2 = find(lat>30 & lat<37);
...
% --- Amazon ----
id1 = find(lon>=289 & lon<=294);
id2 = find(lat>-5 & lat<0);
...
% --- Central africa ----
id1 = find(lon>=14 & lon<18);
id2 = find(lat>7 & lat<10);
...
% --- East Asia ----
id1 = find(lon>=115 & lon<120);
id2 = find(lat>32 & lat<36);
...
saveas(gcf,'lca_zpbl_diurnal_jja.png')

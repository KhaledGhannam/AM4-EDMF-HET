...
xis=gca;
ax1.FontSize = 16;
line1 = plot(t_axis,circshift(precip_land_jja - precip_am4_land_jja,-7),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET - AM4-Lock');
hold on
line2 = plot(t_axis,circshift(precip_land_jja - precip_ncep_land_jja ,-7),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET - AM4-EDMF');
...
set(hh,'Orientation','Vertical','Position',[0.04 0.796 0.195075760569109 0.122674420939227],...
    'box','off','Fontsize',16)
...
xis=gca;
ax2.FontSize = 16;
line1 = plot(t_axis,circshift(precip_land_jja - precip_am4_land_jja,-5),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET - AM4-Lock');
hold on
line2 = plot(t_axis,circshift(precip_land_jja - precip_ncep_land_jja  ,-5),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET - AM4-EDMF');
...
xis=gca;
ax3.FontSize = 16;
line1 = plot(t_axis,circshift(precip_land_jja - precip_am4_land_jja,-4),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET - AM4-Lock');
hold on
line2 = plot(t_axis,circshift(precip_land_jja - precip_ncep_land_jja  ,-4),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET - AM4-EDMF');
...
xis=gca;
ax5.FontSize = 16;
line1 = plot(t_axis,circshift(precip_land_jja - precip_am4_land_jja,+3),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET - AM4-Lock');
hold on
line2 = plot(t_axis,circshift(precip_land_jja - precip_ncep_land_jja  ,+3),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET - AM4-EDMF');
...
xis=gca;
ax5.FontSize = 16;
line1 = plot(t_axis,circshift(precip_land_jja - precip_am4_land_jja,+6),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET - AM4-Lock');
hold on
line2 = plot(t_axis,circshift(precip_land_jja - precip_ncep_land_jja  ,+6),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET - AM4-EDMF');
%line3 = plot(t_axis,circshift(precip_am4_land_jja,+7),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');
...
saveas(gcf,'zpbl_diff_diurnal_jja.png')

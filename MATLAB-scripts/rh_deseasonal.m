...
contourm(latx,lonx,lm,'k','LineWidth',1);
box off; axis off;
caxis([-10 10]); colormap(ax3,bluewhitered(nn));
...
xticklabels({'Dec.','Mar.','Jun.',...
    'Sep.'})
ylabel(sprintf('RH_{ref}  Bias (%s)',per),'FontSize',16)
ylim([-5 25])
yticks([-5 0 10 20])
yticklabels({'','0','10','20'})
set(gca,'Fontsize',16)
...
set(hh,'Orientation','Vertical','Position',[0.50 0.79 0.195075760569109 0.122674420939227],...
    'box','off','Fontsize',16)
...
saveas(gcf,'RHref_deseasonal.png')

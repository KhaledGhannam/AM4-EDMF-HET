...
xis=gca;
ax1.FontSize = 16;
line1 = plot(t_axis,1.*circshift(precip_land_djf,-7),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,1.*circshift(precip_ncep_land_djf,-7),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,1.*circshift(precip_am4_land_djf,-7),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');
...
xis=gca;
ax2.FontSize = 16;
line1 = plot(t_axis,1.*circshift(precip_land_djf,-5),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,1.*circshift(precip_ncep_land_djf,-5),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,1.*circshift(precip_am4_land_djf,-5),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');
...
xis=gca;
ax3.FontSize = 16;
line1 = plot(t_axis,1.*circshift(precip_land_djf,-4),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,1.*circshift(precip_ncep_land_djf,-4),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,1.*circshift(precip_am4_land_djf,-4),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');
...
xis=gca;
ax5.FontSize = 16;
line1 = plot(t_axis,1.*circshift(precip_land_djf,+3),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,1.*circshift(precip_ncep_land_djf,+3),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,1.*circshift(precip_am4_land_djf,+3),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');
...
saveas(gcf,'precipconv_ratio_diurnal_djf.png')

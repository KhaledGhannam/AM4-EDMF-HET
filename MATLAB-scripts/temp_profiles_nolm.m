...
temp_clasp = ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_zas/temp_lev.nc','temp');

pfull_ncep =ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_ncep_zas/temp_lev.nc','pfull');
pfull_clasp =ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_zas/temp_lev.nc','pfull');
...
title({'(a) T (CONUS; 25N-50N)','(AM4-EDMF-HET-MF minus AM4-EDMF)'},'FontSize',14);
...
title({'(b) T (CONUS; 25N-50N)','(AM4-EDMF-HET-MF minus AM4-Lock)'},'FontSize',14);
...
title({'(c) T (Tropical Africa; 10S-10N)','(AM4-EDMF-HET-MF minus AM4-EDMF)'},'FontSize',14);
...
title({'(d) T (Tropical Africa; 10S-10N)','(AM4-EDMF-HET-MF minus AM4-Lock)'},'FontSize',14);
...
title({'(e) T (Amazon; 10S-10N)','(AM4-EDMF-HET-MF minus AM4-EDMF)'},'FontSize',14);
...
title({'(f) T (Amazon; 10S-10N)','(AM4-EDMF-HET-MF minus AM4-Lock)'},'FontSize',14);
...
title({'(g) T (East Asia; 20N-40N)','(AM4-EDMF-HET-MF minus AM4-EDMF)'},'FontSize',14);
...
title({'(h) T (East Asia; 20N-40N)','(AM4-EDMF-HET-MF minus AM4-Lock)'},'FontSize',14);

%-----
cd('/home/Khaled.Ghannam/awg/xanadu_2022.08/james_ana_03152023/figures/')
saveas(gcf,'temp_profiles_jja_nolm.png')

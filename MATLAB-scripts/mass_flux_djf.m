...
h4.Ticks = [-0.2 -0.1 -0 0.1 0.2];
h4.TickLabels = {'-0.2','-0.1','0','0.1','0.2'};
%xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([241.8750 260.6250 279.3750])
xticklabels({'120^{\circ}W','100^{\circ}W','80^{\circ}W'})
...
h10.Ticks = [-0.2 -0.1 0 0.1 0.2];
h10.TickLabels = {'-0.2','-0.1','0','0.1','0.2'};
xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([75.6250 95.6250 115.6250])
xticklabels({'75^{\circ}E','95^{\circ}E','115^{\circ}E'})
...
saveas(gcf,'massflux_prof_djf_12302024.png')

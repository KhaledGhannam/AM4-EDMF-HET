...
tdtvdif_clasp = squeeze(ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_lm_zas/tdt_vdif_lev.nc','tdt_vdif'));
...
saveas(gcf,'Ttendency_vdif_djf_landonly.png')

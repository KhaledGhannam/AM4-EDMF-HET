...
title({'(a) P (AM4-EDMF-HET minus ERA)', sprintf('(%s; BIAS=%5.2f; RMSE=%5.2f)',upper(sea),s.bias41,s.rmse41)},'FontSize',14);
%------------------------------------------------
...
hh=legend('GPCP','AM4-Lock','AM4-EDMF','AM4-EDMF-HET');
set(hh,'Orientation','Vertical','Position',[0.759 0.36015617652079027 0.195075760569109 0.122674420939227],...
    'box','off','Fontsize',16)
...
saveas(gcf,'precip_seasonalrev.png')

...
hh=legend([line1 line2 line3 line4]);
set(hh,'Orientation','Vertical','Position',[0.14 0.78 0.195075760569109 0.122674420939227],...
    'box','off','Fontsize',16)
...
ylabel('Pressure (hPa)','FontSize',16)
xlabel('T tendency (K/hr)','FontSize',16)
title('(e) Equatorial Africa','FontSize',14)
set(gca,'XMinorTick','on','YMinorTick','on')
set(gca,'TickDir','out');
set(gca,'Fontsize',16);
%-----------------------------------------------
...
saveas(gcf,'tdt_han_jja_sixprof_revised.png')

...
% --- NCEP ------
mu_ncep = squeeze(ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_ncep_zas/Md_han_lev.nc','Md_han'));

mu_clasp = squeeze(ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_lm_zas/Md_han_lev.nc','Md_han'));
...
x_ncep=squeeze(mean(mu_ncep(:,:,end-10:end,:),3,'omitnan'));
x_clasp=squeeze(mean(mu_clasp(:,:,end-10:end,:),3,'omitnan'));
...
title({'(a) Vertically averaged M_{d}', '(AM4-EDMF-HET)'},'FontSize',14);
...
title({'(b) Vertically averaged M_{d}', '(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
...
%------- Md vertical profiles zonal means (land only)-----
...
h3.Ticks = [0 0.1 0.2 0.3 0.4];
h3.TickLabels = {'0','0.1','0.2','0.3','0.4'};
xticks([241.8750 260.6250 279.3750])
xticklabels({'120^{\circ}W','100^{\circ}W','80^{\circ}W'})
%xlabel('Longitude')
ylabel('Pressure (hPa)')
set(get(h3,'Title') ,'String','cm/s');
title({'(a) M_{d} (CONUS; 25N-50N)','(AM4-EDMF-HET)'},'FontSize',14);
...
title({'(b) M_{d} (CONUS; 25N-50N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
...
title({'(c) M_{d} (Tropical Africa; 10S-10N)','(AM4-EDMF-HET)'},'FontSize',14);
...
h6.Ticks = [-0.08 -0.04 0 0.04 0.08];
h6.TickLabels = {'-0.08','-0.04','0','0.04','0.08'};
%xlabel('Longitude')
ylabel('Pressure (hPa)')
xticks([15.6250 30.6250 45.6250])
xticklabels({'15^{\circ}E','30^{\circ}E','45^{\circ}E'})
set(get(h6,'Title') ,'String','cm/s');
title({'(d) M_{d} (Tropical Africa; 10S-10N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
...
title({'(e) M_{d} (Amazon; 10S-10N)','(AM4-EDMF-HET)'},'FontSize',14);
...
h8.Ticks = [-0.08 -0.04 0 0.04 0.08];
h8.TickLabels = {'-0.08','-0.04','0','0.04','0.08'};
%xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([281.8750 300.6250 319.3750])
xticklabels({'80^{\circ}W','60^{\circ}W','40^{\circ}W'})
set(get(h8,'Title') ,'String','cm/s');
title({'(f) M_{d} (Amazon; 10S-10N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
...
title({'(g) M_{d} (East Asia; 20N-40N)','(AM4-EDMF-HET)'},'FontSize',14);
...
h10.Ticks = [-0.08 -0.04 0 0.04 0.08];
h10.TickLabels = {'-0.08','-0.04','0','0.04','0.08'};
xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([75.6250 95.6250 115.6250])
xticklabels({'75^{\circ}E','95^{\circ}E','115^{\circ}E'})
set(get(h10,'Title') ,'String','cm/s');
title({'(h) M_{d} (East Asia; 20N-40N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
%-----

cd('/home/Khaled.Ghannam/awg/xanadu_2022.08/james_ana_03152023/figures/')
saveas(gcf,'downdraft_prof_jja.png')
cd('/home/Khaled.Ghannam/awg/xanadu_2022.08/james_ana_03152023/plotting_scripts/')
%-------
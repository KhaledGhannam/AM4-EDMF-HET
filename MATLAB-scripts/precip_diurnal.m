...
% --- western US ----
id1 = find(lon>=245 & lon<=250);
id2 = find(lat>25 & lat<30);
...
xis=gca;
ax1.FontSize = 16;
line1 = plot(t_axis,86400.*circshift(precip_land_ann,-7),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,86400.*circshift(precip_ncep_land_ann,-7),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,86400.*circshift(precip_am4_land_ann,-7),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');

%line4 = plot(t_axis,86400.*circshift(precipconv_land_ann,-7),'r--','linewidth',1.25);
hold on
%line5 = plot(t_axis,86400.*circshift(precipconv_ncep_land_ann,-7),'b--','linewidth',1.25);
%line6 = plot(t_axis,86400.*circshift(precipconv_am4_land_ann,-7),'g--','linewidth',1.25);
...
% --- central US ----
id1 = find(lon>=265 & lon<=275);
id2 = find(lat>35 & lat<40);
...
xis=gca;
ax2.FontSize = 16;
line1 = plot(t_axis,86400.*circshift(precip_land_ann,-5),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,86400.*circshift(precip_ncep_land_ann,-5),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,86400.*circshift(precip_am4_land_ann,-5),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');

%line4 = plot(t_axis,86400.*circshift(precipconv_land_ann,-5),'r--','linewidth',1.25);
hold on
%line5 = plot(t_axis,86400.*circshift(precipconv_ncep_land_ann,-5),'b--','linewidth',1.25);
%line6 = plot(t_axis,86400.*circshift(precipconv_am4_land_ann,-5),'g--','linewidth',1.25);
...
% --- Eastern US ----
id1 = find(lon>=280 & lon<=290);
id2 = find(lat>33 & lat<40);
...
xis=gca;
ax3.FontSize = 16;
line1 = plot(t_axis,86400.*circshift(precip_land_ann,-4),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,86400.*circshift(precip_ncep_land_ann,-4),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,86400.*circshift(precip_am4_land_ann,-4),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');

%line4 = plot(t_axis,86400.*circshift(precipconv_land_ann,-4),'r--','linewidth',1.25);
hold on
%line5 = plot(t_axis,86400.*circshift(precipconv_ncep_land_ann,-4),'b--','linewidth',1.25);
%line6 = plot(t_axis,86400.*circshift(precipconv_am4_land_ann,-4),'g--','linewidth',1.25);
...
% --- Amazon ----
id1 = find(lon>=295 & lon<=305);
id2 = find(lat>-2 & lat<6);
...
% --- Central africa ----
id1 = find(lon>=30 & lon<40);
id2 = find(lat>-1 & lat<6);
...
xis=gca;
ax5.FontSize = 16;
line1 = plot(t_axis,86400.*circshift(precip_land_ann,+3),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,86400.*circshift(precip_ncep_land_ann,+3),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,86400.*circshift(precip_am4_land_ann,+3),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');

%line4 = plot(t_axis,86400.*circshift(precipconv_land_ann,+3),'r--','linewidth',1.25);
hold on
%line5 = plot(t_axis,86400.*circshift(precipconv_ncep_land_ann,+3),'b--','linewidth',1.25);
%line6 = plot(t_axis,86400.*circshift(precipconv_am4_land_ann,+3),'g--','linewidth',1.25);
...
% --- East Asia ----
id1 = find(lon>=85 & lon<90);
id2 = find(lat>22 & lat<28);
...
saveas(gcf,'precip_diurnal_annual.png')

...
f_orig = '/archive/Khaled.Ghannam/awg/xanadu_2022.08/concatenation/1980_2014_am4/diff_t_lev.nc';
...
% --- NCEP ------
temp_am4 = ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/concatenation/1980_2014_am4/diff_t_lev.nc','diff_t');
temp_ncep = ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_ncep_zas/diff_t_lev.nc','diff_t');
temp_clasp = ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_lm_zas/diff_t_lev.nc','diff_t');

pfull_ncep =ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_ncep_zas/diff_t_lev.nc','phalf');
pfull_clasp =ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_lm_zas/diff_t_lev.nc','phalf');
...
xx=repmat(land_frac,1,1,34,420);
...
h3.Ticks = [-50 -25 0 25 50];
h3.TickLabels = {'-50','-25','0','25','50'};
xticks([241.8750 260.6250 279.3750])
xticklabels({'120^{\circ}W','100^{\circ}W','80^{\circ}W'})
xlabel('Longitude')
ylabel('Pressure (hPa)')
set(get(h3,'Title') ,'String','m^{2}/s');
title({'(a) K_{T} (CONUS; 25N-50N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
...
set(ax4,'TickDir','out');
caxis([-180 180]);
colormap(ax4,bluewhitered(30)); freezeColors;
h4=colorbar('Location','eastoutside','Position',pos4,'FontSize',16); cbfreeze(h4,cmap);
h4.Ticks = [-180 -90 0 90 180];
h4.TickLabels = {'-180','-90','0','90','180'};
xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([241.8750 260.6250 279.3750])
xticklabels({'120^{\circ}W','100^{\circ}W','80^{\circ}W'})
set(get(h4,'Title') ,'String','m^{2}/s');
title({'(b) K_{T} (CONUS; 25N-50N)','(AM4-EDMF-HET minus AM4-Lock)'},'FontSize',14);
...
set(ax5,'TickDir','out');
caxis([-50 50]); colormap(ax5,bluewhitered(30)); freezeColors;
h5=colorbar('Location','eastoutside','Position',pos5,'FontSize',16);
h5.Ticks = [-50 -25 0 25 50];
h5.TickLabels = {'-50','-25','0','25','50'};
xticks([15.6250 30.6250 45.6250])
xticklabels({'15^{\circ}E','30^{\circ}E','45^{\circ}E'})
xlabel('Longitude')
ylabel('Pressure (hPa)')
set(get(h5,'Title') ,'String','m^{2}/s');
title({'(c) K_{T} (Tropical Africa; 10S-10N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
...
set(ax6,'TickDir','out');
caxis([-180 180]); colormap(ax6,bluewhitered(30)); freezeColors;
h6=colorbar('Location','eastoutside','Position',pos6,'FontSize',16); cbfreeze(h6,cmap);
h6.Ticks = [-180 -90 0 90 180];
h6.TickLabels = {'-180','-90','0','90','180'};
xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([15.6250 30.6250 45.6250])
xticklabels({'15^{\circ}E','30^{\circ}E','45^{\circ}E'})
set(get(h6,'Title') ,'String','m^{2}/s);
title({'(d) K_{T} (Tropical Africa; 10S-10N)','(AM4-EDMF-HET minus AM4-Lock)'},'FontSize',14);
...
saveas(gcf,'temp_profiles_jja.png')
...
set(ax3,'Xminortick','on')
set(ax3,'TickDir','out');
caxis([-1 1]); colormap(ax3,bluewhitered(30)); freezeColors;
h3=colorbar('Location','eastoutside','Position',pos3,'FontSize',16);

...
title({'(b) Vertically averaged M_{u}', '(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
...
title({'(c) M_{u} (Equatorial Africa; 10S-10N)','(AM4-EDMF-HET)'},'FontSize',14);
...
title({'(d) M_{u} (Equatorial Africa; 10S-10N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
...
%-----
cd('/home/Khaled.Ghannam/awg/xanadu_2022.08/james_ana_03152023/figures/')
saveas(gcf,'massflux_prof_jja_12302024_revised.png')
cd('/home/Khaled.Ghannam/awg/xanadu_2022.08/james_ana_03152023/plotting_scripts/')
%-------

...
precip_land = zpblRi; precip_land(xx<0.4)=NaN;
precip_ncep_land = zpblRi_ncep; precip_ncep_land(xx<0.4)=NaN;
precip_am4_land = zpblRi_am4; precip_am4_land(xx<0.4)=NaN;
...
saveas(gcf,'zpbl_diurnal_jja.png')

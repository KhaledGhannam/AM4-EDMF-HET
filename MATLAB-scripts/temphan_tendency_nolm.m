...
tdtvdif_clasp = squeeze(ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_zas/tdt_han_lev.nc','tdt_han'));
...
saveas(gcf,'Ttendency_han_landonly_nolm.png')

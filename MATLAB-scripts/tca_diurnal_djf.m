...
precip_land = tca; precip_land(xx<0.4)=NaN;
precip_ncep_land = tca_ncep; precip_ncep_land(xx<0.4)=NaN;
precip_am4_land = tca_am4; precip_am4_land(xx<0.4)=NaN;
...
xis=gca;
ax1.FontSize = 16;
line1 = plot(t_axis,circshift(precip_land_djf,-7),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,circshift(precip_ncep_land_djf,-7),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,circshift(precip_am4_land_djf,-7),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');


hh=legend([line1 line2 line3]);
set(hh,'Orientation','Vertical','Position',[0.06 0.78 0.195075760569109 0.122674420939227],...
    'box','off','Fontsize',16)
...
ylim([30 50])
yticks([30 40 50])
yticklabels({'30', '40', '50'})
ylabel(sprintf('TCA (%s)','%'),'FontSize',16)
...
xis=gca;
ax2.FontSize = 16;
line1 = plot(t_axis,circshift(precip_land_djf,-5),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,circshift(precip_ncep_land_djf,-5),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,circshift(precip_am4_land_djf,-5),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');
...
xis=gca;
ax3.FontSize = 16;
line1 = plot(t_axis,circshift(precip_land_djf,-4),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,circshift(precip_ncep_land_djf,-4),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,circshift(precip_am4_land_djf,-4),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');
...
xis=gca;
ax5.FontSize = 16;
line1 = plot(t_axis,circshift(precip_land_djf,+3),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,circshift(precip_ncep_land_djf,+3),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,circshift(precip_am4_land_djf,+3),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');
...
saveas(gcf,'tca_diurnal_djf.png')

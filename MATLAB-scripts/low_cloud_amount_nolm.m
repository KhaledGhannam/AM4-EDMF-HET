...
% --- CLASP ------
lca_clasp = squeeze(mean(ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_zas/low_cld_amt.nc','low_cld_amt'),...
        3,'omitnan'));

tca_clasp = squeeze(mean(ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_zas/tot_cld_amt.nc','tot_cld_amt'),...
        3,'omitnan'));
...
saveas(gcf,'low_total_cloud_annualmean_nolm.png')

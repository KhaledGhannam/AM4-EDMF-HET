...
% --- NCEP ------
temp_am4 = 1000.*ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/concatenation/1980_2014_am4/sphum_lev.nc','sphum');
temp_ncep = 1000.*ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_ncep_zas/sphum_lev.nc','sphum');
temp_clasp = 1000.*ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_lm_zas/sphum_lev.nc','sphum');

pfull_ncep =ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_ncep_zas/sphum_lev.nc','pfull');
pfull_clasp =ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_lm_zas/sphum_lev.nc','pfull');
...
%------- Sphum vertical profiles zonal means (land only)-----
...
ax3=subplot('Position',p3); clear a; a=slice_us_clasp_jja - slice_us_ncep_jja;
...
set(ax3,'TickDir','out');
caxis([-0.4 0.4]); colormap(ax3,bluewhitered(30)); freezeColors;
h3=colorbar('Location','eastoutside','Position',pos3,'FontSize',16);
h3.Ticks = [-0.4 -0.2 0 0.2 0.4];
h3.TickLabels = {'-0.4','-0.2','0','0.2','0.4'};
xticks([241.8750 260.6250 279.3750])
xticklabels({'120^{\circ}W','100^{\circ}W','80^{\circ}W'})
%xlabel('Longitude')
ylabel('Pressure (hPa)')
set(get(h3,'Title') ,'String','g/kg');
title({'(a) q_{s} (CONUS; 25N-50N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);


ax4=subplot('Position',p4); clear a; a=slice_us_clasp_jja - slice_us_am4_jja;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 10, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
...
set(ax4,'TickDir','out');
caxis([-0.8 0.8]); colormap(ax4,bluewhitered(30)); freezeColors;
h4=colorbar('Location','eastoutside','Position',pos4,'FontSize',16); cbfreeze(h4,cmap);
h4.Ticks = [-0.8 -0.4 0 0.4 0.8];
h4.TickLabels = {'-0.8','-0.4','0','0.4','0.8'};
%xlabel('Longitude')
ylabel('Pressure (hPa)')
xticks([241.8750 260.6250 279.3750])
xticklabels({'120^{\circ}W','100^{\circ}W','80^{\circ}W'})
set(get(h4,'Title') ,'String','g/kg');
title({'(b) q_{s} (CONUS; 25N-50N)','(AM4-EDMF-HET minus AM4-Lock)'},'FontSize',14);
...
ax5=subplot('Position',p5); clear a; a=slice_afr_clasp_jja - slice_afr_ncep_jja;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 10, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
...
set(ax5,'TickDir','out');
caxis([-0.4 0.4]); colormap(ax5,bluewhitered(30)); freezeColors;
h5=colorbar('Location','eastoutside','Position',pos5,'FontSize',16);
h5.Ticks = [-0.4 -0.2 0 0.2 0.4];
h5.TickLabels = {'-0.4','-0.2','0','0.2','0.4'};
xticks([15.6250 30.6250 45.6250])
xticklabels({'15^{\circ}E','30^{\circ}E','45^{\circ}E'})
%xlabel('Longitude')
ylabel('Pressure (hPa)')
set(get(h5,'Title') ,'String','g/kg');
title({'(c) q_{s} (Tropical Africa; 10S-10N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);


ax6=subplot('Position',p6); clear a; a=slice_afr_clasp_jja - slice_afr_am4_jja;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 10, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
...
set(ax6,'TickDir','out');
caxis([-0.8 0.8]); colormap(ax6,bluewhitered(30)); freezeColors;
h6=colorbar('Location','eastoutside','Position',pos6,'FontSize',16); cbfreeze(h6,cmap);
h6.Ticks = [-0.8 -0.4 0 0.4 0.8];
h6.TickLabels = {'-0.8','-0.4','0','0.4','0.8'};
%xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([15.6250 30.6250 45.6250])
xticklabels({'15^{\circ}E','30^{\circ}E','45^{\circ}E'})
set(get(h6,'Title') ,'String','g/kg');
title({'(d) q_{s} (Tropical Africa; 10S-10N)','(AM4-EDMF-HET minus AM4-Lock)'},'FontSize',14);
...
ax7=subplot('Position',p7); clear a; a=slice_ama_clasp_jja - slice_ama_ncep_jja;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 10, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
...
set(ax7,'TickDir','out');
caxis([-0.4 0.4]); colormap(ax7,bluewhitered(30)); freezeColors;
h7=colorbar('Location','eastoutside','Position',pos7,'FontSize',16);
h7.Ticks = [-0.4 -0.2 0 0.2 0.4];
h7.TickLabels = {'-0.4','-0.2','0','0.2','0.4'};
%xlabel('Longitude')
ylabel('Pressure (hPa)')
xticks([281.8750 300.6250 319.3750])
xticklabels({'80^{\circ}W','60^{\circ}W','40^{\circ}W'})
set(get(h7,'Title') ,'String','g/kg');
title({'(e) q_{s} (Amazon; 10S-10N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);


ax8=subplot('Position',p8); clear a; a=slice_ama_clasp_jja - slice_ama_am4_jja;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 10, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
...
set(ax8,'TickDir','out');
caxis([-0.8 0.8]); colormap(ax8,bluewhitered(30)); freezeColors;
h8=colorbar('Location','eastoutside','Position',pos8,'FontSize',16); cbfreeze(h8,cmap);
h8.Ticks = [-0.8 -0.4 0 0.4 0.8];
h8.TickLabels = {'-0.8','-0.4','0','0.4','0.8'};
%xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([281.8750 300.6250 319.3750])
xticklabels({'80^{\circ}W','60^{\circ}W','40^{\circ}W'})
set(get(h8,'Title') ,'String','g/kg');
title({'(f) q_{s} (Amazon; 10S-10N)','(AM4-EDMF-HET minus AM4-Lock)'},'FontSize',14);
...
ax9=subplot('Position',p9); clear a; a=slice_esia_clasp_jja - slice_esia_ncep_jja;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 10, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
...
set(ax9,'TickDir','out');
caxis([-0.4 0.4]); colormap(ax9,bluewhitered(30)); freezeColors;
h9=colorbar('Location','eastoutside','Position',pos9,'FontSize',16);
h9.Ticks = [-0.4 -0.2 0 0.2 0.4];
h9.TickLabels = {'-0.4','-0.2','0','0.2','0.4'};
%xlim([75 115])
xticks([75.6250 95.6250 115.6250])
xticklabels({'75^{\circ}E.','95^{\circ}E.','115^{\circ}E.'})
xlabel('Longitude')
ylabel('Pressure (hPa)')
set(get(h9,'Title') ,'String','g/kg');
title({'(g) q_{s} (East Asia; 20N-40N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);


ax10=subplot('Position',p10); clear a; a=slice_esia_clasp_jja - slice_esia_am4_jja;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 10, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
...
caxis([-0.8 0.8]); colormap(ax10,bluewhitered(30)); freezeColors;
h10=colorbar('Location','eastoutside','Position',pos10,'FontSize',16); cbfreeze(h8,cmap);
h10.Ticks = [-0.8 -0.4 0 0.4 0.8];
h10.TickLabels = {'-0.8','-0.4','0','0.4','0.8'};
xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([75.6250 95.6250 115.6250])
xticklabels({'75^{\circ}E.','95^{\circ}E.','115^{\circ}E.'})
set(get(h10,'Title') ,'String','g/kg');
title({'(h) q_{s} (East Asia; 20N-40N)','(AM4-EDMF-HET minus AM4-Lock)'},'FontSize',14);

%-----
cd('/home/Khaled.Ghannam/awg/xanadu_2022.08/james_ana_03152023/figures/')
saveas(gcf,'sphum_profiles_jja.png')
...
set(ax3,'Xminortick','on')
set(ax3,'TickDir','out');
caxis([-0.2 0.2]); colormap(ax3,bluewhitered(30)); freezeColors;
h3=colorbar('Location','eastoutside','Position',pos3,'FontSize',16);
h3.Ticks = [-0.2 -0.1 0 0.1 0.2];
h3.TickLabels = {'-0.2','-0.1','0','0.1','0.2'};
xticks([241.8750 260.6250 279.3750])
xticklabels({'120^{\circ}W','100^{\circ}W','80^{\circ}W'})
xlabel('Longitude')
ylabel('Pressure (hPa)')
...
set(ax4,'Xminortick','on')
set(ax4,'TickDir','out');
caxis([-0.4 0.4]); colormap(ax4,bluewhitered(30)); freezeColors;
h4=colorbar('Location','eastoutside','Position',pos4,'FontSize',16); cbfreeze(h4,cmap);
h4.Ticks = [-0.4 -0.2 0 0.2 0.4];
h4.TickLabels = {'-0.4','-0.2','0','0.2','0.4'};
xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([241.8750 260.6250 279.3750])
xticklabels({'120^{\circ}W','100^{\circ}W','80^{\circ}W'})
...
set(ax7,'Xminortick','on')
set(ax7,'TickDir','out');
caxis([-0.6 0.6]); colormap(ax7,bluewhitered(30)); freezeColors;
h7=colorbar('Location','eastoutside','Position',pos7,'FontSize',16);
h7.Ticks = [-0.6 -0.3 0 0.3 0.6];
h7.TickLabels = {'-0.6','-0.3','0','0.3','0.6'};
xlabel('Longitude')
ylabel('Pressure (hPa)')
xticks([281.8750 300.6250 319.3750])
xticklabels({'80^{\circ}W','60^{\circ}W','40^{\circ}W'})
...
set(ax8,'Xminortick','on')
set(ax8,'TickDir','out');
caxis([-0.6 0.6]); colormap(ax8,bluewhitered(30)); freezeColors;
h8=colorbar('Location','eastoutside','Position',pos8,'FontSize',16); cbfreeze(h8,cmap);
h8.Ticks = [-0.6 -0.3 0 0.3 0.6];
h8.TickLabels = {'-0.6','-0.3','0','0.3','0.6'};
xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([281.8750 300.6250 319.3750])
xticklabels({'80^{\circ}W','60^{\circ}W','40^{\circ}W'})
...
set(ax10,'Xminortick','on')
set(ax10,'TickDir','out');
caxis([-0.6 0.6]); colormap(ax10,bluewhitered(30)); freezeColors;
h10=colorbar('Location','eastoutside','Position',pos10,'FontSize',16); cbfreeze(h8,cmap);
h10.Ticks = [-0.6 -0.3 0 0.3 0.6];
h10.TickLabels = {'-0.6','-0.3','0','0.3','0.6'};
xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([75.6250 95.6250 115.6250])
xticklabels({'75^{\circ}E.','95^{\circ}E.','115^{\circ}E.'})
...
%-----
cd('/home/Khaled.Ghannam/awg/xanadu_2022.08/james_ana_03152023/figures/')
saveas(gcf,'sphum_profiles_djf.png')
cd('/home/Khaled.Ghannam/awg/xanadu_2022.08/james_ana_03152023/plotting_scripts/')
%-------

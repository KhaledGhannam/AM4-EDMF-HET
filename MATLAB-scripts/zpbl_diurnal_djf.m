...
set(hh,'Orientation','Vertical','Position',[0.04 0.78 0.195075760569109 0.122674420939227],...
    'box','off','Fontsize',16)
...
ylabel('ABL height, h (m)','FontSize',16)
...
saveas(gcf,'zpbl_diurnal_djf.png')

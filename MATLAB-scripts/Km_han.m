...
per='%';
% ---- read variables -----
tdtvdif_ncep = squeeze(ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_ncep_zas/diff_t_lev.nc','diff_t'));

tdtvdif_clasp = squeeze(ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_lm_zas/diff_t_lev.nc','diff_t'));

pfull_ncep = squeeze(ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_ncep_zas/diff_t_lev.nc','phalf'));

pfull_clasp = squeeze(ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_lm_zas/diff_t_lev.nc','phalf'));
...
title({'(a) K_{m} (CONUS; 25N-50N)','(AM4-EDMF-HET)'},'FontSize',14);
...
title({'(b) K_{m} (CONUS; 25N-50N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
...
title({'(c) K_{m} (Tropical Africa; 10S-10N)','(AM4-EDMF-HET)'},'FontSize',14);
...
title({'(d) K_{m} (Tropical Africa; 10S-10N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
...
title({'(e) K_{m} (Amazon; 10S-10N)','(AM4-EDMF-HET)'},'FontSize',14);
...
title({'(f) K_{m} (Amazon; 10S-10N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
...
title({'(g) K_{m} (East Asia; 20N-40N)','(AM4-EDMF-HET)'},'FontSize',14);
...
title({'(h) K_{m} (East Asia; 20N-40N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);

%-----
cd('/home/Khaled.Ghannam/awg/xanadu_2022.08/james_ana_03152023/figures/')
saveas(gcf,'Km_han_jja_landonly.png')

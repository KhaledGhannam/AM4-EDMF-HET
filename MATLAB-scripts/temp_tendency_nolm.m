...
% ---- read variables -----
tdtvdif_ncep = squeeze(ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_ncep_zas/tdt_vdif_lev.nc','tdt_vdif'));

tdtvdif_clasp = squeeze(ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_zas/tdt_vdif_lev.nc','tdt_vdif'));
...
pfull_clasp = squeeze(ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_zas/tdt_vdif_lev.nc','pfull'));
...
set(ax6,'TickDir','out');
caxis([-0.06 0.06]); colormap(ax6,bluewhitered(nn)); freezeColors;
...
set(ax8,'TickDir','out');
caxis([-0.06 +0.06]); colormap(ax8,bluewhitered(nn)); freezeColors;
...
saveas(gcf,'Ttendency_vdif_landonly_nolm.png')

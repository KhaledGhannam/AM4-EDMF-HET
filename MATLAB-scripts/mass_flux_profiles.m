...
%----- annual means ---------
mu_ncep_ann=squeeze(mean(mu_ncep,4,'omitnan'));
mu_clasp_ann=squeeze(mean(mu_clasp,4,'omitnan'));


%--------------------------

%----- jja means ---------
mu_ncep_jja=reshape(mu_ncep,288,180,33,12,[]);
mu_ncep_jja = squeeze(mean(mean(mu_ncep_jja(:,:,:,6:8,:),4,'omitnan'),5,'omitnan'));

mu_clasp_jja=reshape(mu_clasp,288,180,33,12,[]);
mu_clasp_jja = squeeze(mean(mean(mu_clasp_jja(:,:,:,6:8,:),4,'omitnan'),5,'omitnan'));

t_ncep_jja=reshape(t_ncep,288,180,33,12,[]);
t_ncep_jja = squeeze(mean(mean(t_ncep_jja(:,:,:,6:8,:),4,'omitnan'),5,'omitnan'));

t_clasp_jja=reshape(t_clasp,288,180,33,12,[]);
t_clasp_jja = squeeze(mean(mean(t_clasp_jja(:,:,:,6:8,:),4,'omitnan'),5,'omitnan'));

cld_ncep_jja=reshape(cld_ncep,288,180,33,12,[]);
cld_ncep_jja = squeeze(mean(mean(cld_ncep_jja(:,:,:,6:8,:),4,'omitnan'),5,'omitnan'));

cld_clasp_jja=reshape(cld_clasp,288,180,33,12,[]);
cld_clasp_jja = squeeze(mean(mean(cld_clasp_jja(:,:,:,6:8,:),4,'omitnan'),5,'omitnan'));

%---------------------------------------------


%----- djf means ---------
mu_ncep_djf=reshape(mu_ncep,288,180,33,12,[]);
mu_ncep_djf = squeeze(mean(mean(mu_ncep_djf(:,:,:,1:2,:),4,'omitnan'),5,'omitnan'));

mu_clasp_djf=reshape(mu_clasp,288,180,33,12,[]);
mu_clasp_djf = squeeze(mean(mean(mu_clasp_djf(:,:,:,1:2,:),4,'omitnan'),5,'omitnan'));

t_ncep_djf=reshape(t_ncep,288,180,33,12,[]);
t_ncep_djf = squeeze(mean(mean(t_ncep_djf(:,:,:,1:2,:),4,'omitnan'),5,'omitnan'));

t_clasp_djf=reshape(t_clasp,288,180,33,12,[]);
t_clasp_djf = squeeze(mean(mean(t_clasp_djf(:,:,:,1:2,:),4,'omitnan'),5,'omitnan'));

cld_ncep_djf=reshape(cld_ncep,288,180,33,12,[]);
cld_ncep_djf = squeeze(mean(mean(cld_ncep_djf(:,:,:,1:2,:),4,'omitnan'),5,'omitnan'));

cld_clasp_djf=reshape(cld_clasp,288,180,33,12,[]);
cld_clasp_djf = squeeze(mean(mean(cld_clasp_djf(:,:,:,1:2,:),4,'omitnan'),5,'omitnan'));
...
clear id1 id2
id1 = find(lon>=12 & lon<=15); %--- Western US longitude span---
id2 = find(lat>-10 & lat<10); %--- Western US latitude span---

xx=repmat(land_frac,1,1,33);
mu_ncep_ann(xx<0.4)=NaN;
mu_clasp_ann(xx<0.4)=NaN;
t_ncep_ann(xx<0.4)=NaN;
t_clasp_ann(xx<0.4)=NaN;
cld_ncep_ann(xx<0.4)=NaN;
cld_clasp_ann(xx<0.4)=NaN;


mu_ncep_ann = squeeze(mean(mean(mu_ncep_ann(id1,id2,:),1,'omitnan'),2,'omitnan'));
mu_clasp_ann = squeeze(mean(mean(mu_clasp_ann(id1,id2,:),1,'omitnan'),2,'omitnan'));
t_ncep_ann = squeeze(mean(mean(t_ncep_ann(id1,id2,:),1,'omitnan'),2,'omitnan'));
t_clasp_ann = squeeze(mean(mean(t_clasp_ann(id1,id2,:),1,'omitnan'),2,'omitnan'));
cld_ncep_ann = squeeze(mean(mean(cld_ncep_ann(id1,id2,:),1,'omitnan'),2,'omitnan'));
cld_clasp_ann = squeeze(mean(mean(cld_clasp_ann(id1,id2,:),1,'omitnan'),2,'omitnan'));


mu_ncep_jja = squeeze(mean(mean(mu_ncep_jja(id1,id2,:),1,'omitnan'),2,'omitnan'));
mu_clasp_jja = squeeze(mean(mean(mu_clasp_jja(id1,id2,:),1,'omitnan'),2,'omitnan'));
t_ncep_jja = squeeze(mean(mean(t_ncep_jja(id1,id2,:),1,'omitnan'),2,'omitnan'));
t_clasp_jja = squeeze(mean(mean(t_clasp_jja(id1,id2,:),1,'omitnan'),2,'omitnan'));
cld_ncep_jja = squeeze(mean(mean(cld_ncep_jja(id1,id2,:),1,'omitnan'),2,'omitnan'));
cld_clasp_jja = squeeze(mean(mean(cld_clasp_jja(id1,id2,:),1,'omitnan'),2,'omitnan'));

mu_ncep_djf = squeeze(mean(mean(mu_ncep_djf(id1,id2,:),1,'omitnan'),2,'omitnan'));
mu_clasp_djf = squeeze(mean(mean(mu_clasp_djf(id1,id2,:),1,'omitnan'),2,'omitnan'));
t_ncep_djf = squeeze(mean(mean(t_ncep_djf(id1,id2,:),1,'omitnan'),2,'omitnan'));
t_clasp_djf = squeeze(mean(mean(t_clasp_djf(id1,id2,:),1,'omitnan'),2,'omitnan'));
cld_ncep_djf = squeeze(mean(mean(cld_ncep_djf(id1,id2,:),1,'omitnan'),2,'omitnan'));
cld_clasp_djf = squeeze(mean(mean(cld_clasp_djf(id1,id2,:),1,'omitnan'),2,'omitnan'));
...
p5=  [0.555,          0.67,          0.165, 0.24];
p6=  [0.792,         0.67,          0.165, 0.24];
p7=  [0.04,          0.13,          0.165, 0.24];
p8=  [0.28,          0.13,          0.165, 0.24];
p9=  [0.555,          0.13,          0.165, 0.24];
p10= [0.792,         0.13,          0.165, 0.24];

pos3= [0.215   0.67  0.012 0.22 ];%[left bottom width height];
pos4= [0.455   0.67  0.012 0.22 ];%[left bottom width height];
pos5= [0.730   0.67  0.012 0.22 ];%[left bottom width height];
pos6= [0.965   0.67  0.012 0.22 ];%[left bottom width height];
pos7= [0.215   0.13  0.012 0.22 ];%[left bottom width height];
pos8= [0.455   0.13  0.012 0.22 ];%[left bottom width height];
pos9= [0.730   0.13  0.012 0.22 ];%[left bottom width height];
pos10=[0.965   0.13  0.012 0.22 ];%[left bottom width height];
...
set(ax3,'TickDir','out');
caxis([s.c3 s.c4]); colormap(ax3,cmap); freezeColors;
...
title({'(a) M_{u} (CONUS; 25N-50N)','(AM4-EDMF-HET)'},'FontSize',14);


ax4=subplot('Position',p4); clear a; a=100.*diff_clasp_ncep_jja;
%a(end-8:end-3,13:16)=NaN;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 8, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
set(ax4, 'YDir', 'reverse');
ax4.FontSize = 16;
set(ax4,'Xminortick','on')
set(ax4,'TickDir','out');
caxis([s.cmin3 s.cmax3]); colormap(ax4,bluewhitered(nn)); freezeColors;
h4=colorbar('Location','eastoutside','Position',pos4,'FontSize',16); cbfreeze(h4,cmap);
h4.Ticks = [-0.5 -0.3 -0.1 0.1 0.3 0.5];
h4.TickLabels = {'-0.5','-0.3','-0.1','0.1','0.3','0.5'};
xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([241.8750 260.6250 279.3750])
xticklabels({'120^{\circ}W','100^{\circ}W','80^{\circ}W'})
set(get(h4,'Title') ,'String','cm/s');
title({'(b) M_{u} (CONUS; 25N-50N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
...
ax5=subplot('Position',p5); clear a; a=100.*slice_afr_clasp;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 6, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
...
set(ax5,'TickDir','out');
caxis([s.c3 s.c4]); colormap(ax5,cmap); freezeColors;
...
title({'(c) M_{u} (Tropical Africa; 10S-10N)','(AM4-EDMF-HET)'},'FontSize',14);


ax6=subplot('Position',p6); clear a; a=100.*diff_clasp_ncep;
%a(1:4,13:16)=NaN;
%a(5:end,15:16)=NaN;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 6, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
...
set(ax6,'TickDir','out');
caxis([s.cmin3 s.cmax3]); colormap(ax6,bluewhitered(nn)); freezeColors;
h6=colorbar('Location','eastoutside','Position',pos6,'FontSize',16); cbfreeze(h6,cmap);
h6.Ticks = [-0.5 -0.3 -0.1 0.1 0.3 0.5];
h6.TickLabels = {'-0.5','-0.3','-0.1','0.1','0.3','0.5'};
xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([15.6250 30.6250 45.6250])
xticklabels({'15^{\circ}E','30^{\circ}E','45^{\circ}E'})
set(get(h6,'Title') ,'String','cm/s');
title({'(d) M_{u} (Tropical Africa; 10S-10N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
...
ax7=subplot('Position',p7); clear a; a=100.*slice_ama_clasp;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 6, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
...
set(ax7,'TickDir','out');
caxis([0 4]); colormap(ax7,cmap); freezeColors;
...
title({'(e) M_{u} (Amazon; 10S-10N)','(AM4-EDMF-HET)'},'FontSize',14);


ax8=subplot('Position',p8); clear a; a=100.*diff_clasp_ncep;
%a(:,15:16)=NaN;
%a(5:end,15:16)=NaN;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 8, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
...
set(ax8,'TickDir','out');
caxis([-0.4 +0.4]); colormap(ax8,bluewhitered(nn)); freezeColors;
...
title({'(f) M_{u} (Amazon; 10S-10N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
...
set(ax9,'TickDir','out');
caxis([0 4]); colormap(ax9,cmap); freezeColors;
...
title({'(g) M_{u} (East Asia; 20N-40N)','(AM4-EDMF-HET)'},'FontSize',14);
...
caxis([-0.4 +0.4]); colormap(ax10,bluewhitered(nn)); freezeColors;
...
title({'(h) M_{u} (East Asia; 20N-40N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);

%-----
cd('/home/Khaled.Ghannam/awg/xanadu_2022.08/james_ana_03152023/figures/')
saveas(gcf,'massflux_prof_landonly.png')
...
ax4=subplot('Position',p4); clear a; a=100.*slice_us_ncep_jja;
%a(end-8:end-3,13:16)=NaN;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 8, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
set(ax4, 'YDir', 'reverse');
...
set(ax4,'Xminortick','on')
set(ax4,'TickDir','out');
caxis([s.c3 s.c4]); colormap(ax4,cmap); freezeColors;
h4=colorbar('Location','eastoutside','Position',pos4,'FontSize',16); cbfreeze(h4,cmap);
h4.Ticks = [0 2 4 6];
h4.TickLabels = {'0','2','4','6'};
xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([241.8750 260.6250 279.3750])
xticklabels({'120^{\circ}W','100^{\circ}W','80^{\circ}W'})
set(get(h4,'Title') ,'String','cm/s');
title({'(b) M_{u} (CONUS; 25N-50N)','(AM4-EDMF)'},'FontSize',14);
...
ax6=subplot('Position',p6); clear a; a=100.*slice_afr_ncep;
%a(1:4,13:16)=NaN;
%a(5:end,15:16)=NaN;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 6, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
...
set(ax6,'Xminortick','on')
set(ax6,'TickDir','out');
caxis([s.c3 s.c4]); colormap(ax6,cmap); freezeColors;
h6=colorbar('Location','eastoutside','Position',pos6,'FontSize',16); cbfreeze(h6,cmap);
h6.Ticks = [0 2 4 6];
h6.TickLabels = {'0','2','4','6'};
xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([15.6250 30.6250 45.6250])
xticklabels({'15^{\circ}E','30^{\circ}E','45^{\circ}E'})
set(get(h6,'Title') ,'String','cm/s');
title({'(d) M_{u} (Tropical Africa; 10S-10N)','(AM4-EDMF)'},'FontSize',14);
...
ax8=subplot('Position',p8); clear a; a=100.*slice_ama_ncep;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 6, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
set(ax8, 'YDir', 'reverse');
ax8.FontSize = 16;
set(ax8,'Xminortick','on')
set(ax8,'TickDir','out');
caxis([0 4]); colormap(ax8,cmap); freezeColors;
h8=colorbar('Location','eastoutside','Position',pos8,'FontSize',16); cbfreeze(h8,cmap);
h8.Ticks = [0 1 2 3 4];
h8.TickLabels = {'0','1','2','3','4'};
xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([281.8750 300.6250 319.3750])
xticklabels({'80^{\circ}W','60^{\circ}W','40^{\circ}W'})
set(get(h8,'Title') ,'String','cm/s');
title({'(f) M_{u} (Amazon; 10S-10N)','(AM4-EDMF)'},'FontSize',14);
...
ax10=subplot('Position',p10); clear a; a=100.*slice_esia_ncep_jja;
contourf(lon(id1),flipud(pfull_clasp(end-max_h:end)),a', 6, 'LineStyle', '-',...
"ShowText",true,"LabelFormat","%0.1f", "FaceAlpha",1);
set(ax10, 'YDir', 'reverse');
ax10.FontSize = 16;
set(ax10,'Xminortick','on')
set(ax10,'TickDir','out');
caxis([0 4]); colormap(ax10,cmap); freezeColors;
h10=colorbar('Location','eastoutside','Position',pos10,'FontSize',16); cbfreeze(h8,cmap);
h10.Ticks = [0 1 2 3 4];
h10.TickLabels = {'0','1','2','3','4'};
xlabel('Longitude')
%ylabel('Pressure (hPa)')
xticks([75.6250 95.6250 115.6250])
xticklabels({'75^{\circ}E.','95^{\circ}E.','115^{\circ}E.'})
set(get(h10,'Title') ,'String','cm/s');
title({'(h) M_{u} (East Asia; 20N-40N)','(AM4-EDMF)'},'FontSize',14);

%-----
cd('/home/Khaled.Ghannam/awg/xanadu_2022.08/james_ana_03152023/figures/')
saveas(gcf,'massflux_prof_landonlyedmfvsedmfhet.png')
cd('/home/Khaled.Ghannam/awg/xanadu_2022.08/james_ana_03152023/plotting_scripts/')
%-------

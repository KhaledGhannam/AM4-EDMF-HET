...
tdtvdif_clasp = squeeze(ncread('/archive/Khaled.Ghannam/awg/xanadu_2022.08/james_data_03152023/1980_2014_clasp_lnd_disp_zas/Kt_han_lev.nc','Kt_han'));
...
ylabel('Pressure (hPa)')
yticks([700 800 900])
yticklabels({'700','800','900'})
set(get(h3,'Title') ,'String','m^{2}/s');
title({'(a) K_{t} (CONUS; 25N-50N)','(AM4-EDMF-HET-MF)'},'FontSize',14);
...
title({'(b) K_{t} (CONUS; 25N-50N)','(AM4-EDMF-HET-MF minus AM4-EDMF)'},'FontSize',14);
...
title({'(c) K_{t} (Tropical Africa; 10S-10N)','(AM4-EDMF-HET-MF)'},'FontSize',14);
...
title({'(d) K_{t} (Tropical Africa; 10S-10N)','(AM4-EDMF-HET-MF minus AM4-EDMF)'},'FontSize',14);
...
yticks([900 800 700])
yticklabels({'900','800','700'})
set(get(h7,'Title') ,'String','m^{2}/s');
title({'(e) K_{t} (Amazon; 10S-10N)','(AM4-EDMF-HET-MF)'},'FontSize',14);
...
title({'(f) K_{t} (Amazon; 10S-10N)','(AM4-EDMF-HET-MF minus AM4-EDMF)'},'FontSize',14);
...
title({'(g) K_{t} (East Asia; 20N-40N)','(AM4-EDMF-HET-MF)'},'FontSize',14);
...
title({'(h) K_{t} (East Asia; 20N-40N)','(AM4-EDMF-HET-MF minus AM4-EDMF)'},'FontSize',14);

%-----
cd('/home/Khaled.Ghannam/awg/xanadu_2022.08/james_ana_03152023/figures/')
saveas(gcf,'Kt_han_jja_landonly.png')

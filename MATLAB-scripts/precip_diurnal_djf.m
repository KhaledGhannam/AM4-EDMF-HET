...
xis=gca;
ax1.FontSize = 16;
line1 = plot(t_axis,86400.*circshift(precip_land_djf,-7),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,86400.*circshift(precip_ncep_land_djf,-7),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,86400.*circshift(precip_am4_land_djf,-7),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');

%line4 = plot(t_axis,86400.*circshift(precipconv_land_djf,-7),'r--','linewidth',1.25);
hold on
%line5 = plot(t_axis,86400.*circshift(precipconv_ncep_land_djf,-7),'b--','linewidth',1.25);
%line6 = plot(t_axis,86400.*circshift(precipconv_am4_land_djf,-7),'g--','linewidth',1.25);
...
xis=gca;
ax2.FontSize = 16;
line1 = plot(t_axis,86400.*circshift(precip_land_djf,-5),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,86400.*circshift(precip_ncep_land_djf,-5),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,86400.*circshift(precip_am4_land_djf,-5),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');

%line4 = plot(t_axis,86400.*circshift(precipconv_land_djf,-5),'r--','linewidth',1.25);
hold on
%line5 = plot(t_axis,86400.*circshift(precipconv_ncep_land_djf,-5),'b--','linewidth',1.25);
%line6 = plot(t_axis,86400.*circshift(precipconv_am4_land_djf,-5),'g--','linewidth',1.25);

hh=legend([line1 line2 line3]);
set(hh,'Orientation','Vertical','Position',[0.4 0.78 0.195075760569109 0.122674420939227],...
    'box','off','Fontsize',16)
...
xis=gca;
ax3.FontSize = 16;
line1 = plot(t_axis,86400.*circshift(precip_land_djf,-4),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,86400.*circshift(precip_ncep_land_djf,-4),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,86400.*circshift(precip_am4_land_djf,-4),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');

%line4 = plot(t_axis,86400.*circshift(precipconv_land_djf,-4),'r--','linewidth',1.25);
hold on
%line5 = plot(t_axis,86400.*circshift(precipconv_ncep_land_djf,-4),'b--','linewidth',1.25);
%line6 = plot(t_axis,86400.*circshift(precipconv_am4_land_djf,-4),'g--','linewidth',1.25);
...
xis=gca;
ax5.FontSize = 16;
line1 = plot(t_axis,86400.*circshift(precip_land_djf,+3),'r-o','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF-HET');
hold on
line2 = plot(t_axis,86400.*circshift(precip_ncep_land_djf,+3),'b->','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-EDMF');
line3 = plot(t_axis,86400.*circshift(precip_am4_land_djf,+3),'g-s','MarkerSize',6,'linewidth',1.25,'DisplayName','AM4-Lock');

%line4 = plot(t_axis,86400.*circshift(precipconv_land_djf,+3),'r--','linewidth',1.25);
hold on
%line5 = plot(t_axis,86400.*circshift(precipconv_ncep_land_djf,+3),'b--','linewidth',1.25);
%line6 = plot(t_axis,86400.*circshift(precipconv_am4_land_djf,+3),'g--','linewidth',1.25);
...
saveas(gcf,'precip_diurnal_djf.png')

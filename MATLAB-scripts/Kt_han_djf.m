...
title({'(c) K_{\phi} (Tropical Africa; 10S-10N)','(AM4-EDMF-HET)'},'FontSize',14);
...
title({'(d) K_{\phi} (Tropical Africa; 10S-10N)','(AM4-EDMF-HET minus AM4-EDMF)'},'FontSize',14);
...
saveas(gcf,'Kt_han_djf_landonly_12302024.png')

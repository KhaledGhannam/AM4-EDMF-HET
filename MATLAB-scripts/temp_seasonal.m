...
xticklabels({'Dec.','Mar.','Jun.',...
    'Sep.'})
ylabel('T_{ref} (^{\circ}C)','FontSize',16)
ylim([-30 10])
yticks([-30 -20 -10 0 10])
yticklabels({'-30','-20','-10','0','10'})
set(gca,'Fontsize',16)
hh=legend('ERA','AM4-Lock','AM4-EDMF','AM4-EDMF-HET');
set(hh,'Orientation','Vertical','Position',[0.471873734380386 0.8415617652079027 0.195075760569109 0.122674420939227],...
    'box','off','Fontsize',16)

title(s.s4,'FontSize',14);
%text('Parent',ax4,'Units','normalized','VerticalAlignment','top',...
%    'FontSize',16,...
%    'String','(d)',...
%    'Position',[-0.00404360753221015 1.1396646706587 0],'Interpreter','latex');
...
saveas(gcf,'Tref_seasonalrev.png')
